...
const TaskLibraryPage: React.FC = () => {
  ...
  const handleUseTemplate = (template: TaskTemplate) => {
    // Navigate to Job Tasks page with template ID as URL parameter
    navigate(`/job-tasks?templateId=${template.id}`);
  };
        ...
        <div style={styles.emptyState}>
          ...
          <p style={styles.emptyText}>
            {searchQuery
              ...
              : 'Templates are created by checking "Save as template" when creating a job task on the Job Tasks page.'}
          </p>
        </div>
      ) : (
...
const TaskTemplateCard: React.FC<TaskTemplateCardProps> = ({ template, onDelete, onUseTemplate, isMobile }) => {
