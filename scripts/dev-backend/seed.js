...
const portal_updates = [
  ...
  // No section at all (v55): every family sees it, in both sections. It is
  // also the post the attached files below hang on, which is the combination
  // worth having a fixture for — a file that belongs to no program.
  update(6, null, null, 'Jingle Bell Jam — show info and opt-out form', 'Show info for the December showcase is attached, along with the opt-out form. Return the form by the 30th if your dancer will not be taking part.\n\nCall times follow once numbers are in.', 1, true),
];
...
const portal_documents = [
  { id: '00000000-0000-4000-f000-000000000001', program_id: PROG_ACADEMY, class_id: null, update_id: null, title: 'Family handbook 2026', description: 'Policies, term dates and dress code', category: 'Policies', storage_path: 'demo/handbook.pdf', file_name: 'handbook-2026.pdf', mime_type: 'application/pdf', size_bytes: 1_800_000, sort_order: 0, is_published: true, uploaded_by: STAFF.admin, stream_uid: null, stream_playback_url: null, stream_status: null, stream_download_url: null, duration_seconds: null, created_at: iso(-60), updated_at: iso(-60) },
  { id: '00000000-0000-4000-f000-000000000002', program_id: PROG_ACADEMY, class_id: portal_classes[7].id, update_id: null, title: 'Junior Ballet dress code', description: null, category: 'Dress code', storage_path: 'demo/dress-code.pdf', file_name: 'dress-code.pdf', mime_type: 'application/pdf', size_bytes: 402_000, sort_order: 1, is_published: true, uploaded_by: STAFF.teacherJess, stream_uid: null, stream_playback_url: null, stream_status: null, stream_download_url: null, duration_seconds: null, created_at: iso(-45), updated_at: iso(-45) },
  // Two files on an info post (v65). program_id null, because the post they
  // hang on goes to both sections and so belongs to neither; update_id is what
  // keeps them out of every Files list and under the post instead.
  { id: '00000000-0000-4000-f000-000000000004', program_id: null, class_id: null, update_id: '00000000-0000-4000-d000-000000000006', title: 'Jingle Bell Jam show info', description: '', category: null, storage_path: 'updates/demo-show-info.pdf', file_name: 'jingle-bell-jam-info.pdf', mime_type: 'application/pdf', size_bytes: 640_000, sort_order: 0, is_published: true, uploaded_by: STAFF.admin, stream_uid: null, stream_playback_url: null, stream_status: null, stream_download_url: null, duration_seconds: null, created_at: iso(-1), updated_at: iso(-1) },
  { id: '00000000-0000-4000-f000-000000000005', program_id: null, class_id: null, update_id: '00000000-0000-4000-d000-000000000006', title: 'Opt-out form', description: '', category: null, storage_path: 'updates/demo-opt-out.pdf', file_name: 'opt-out-form.pdf', mime_type: 'application/pdf', size_bytes: 88_000, sort_order: 1, is_published: true, uploaded_by: STAFF.admin, stream_uid: null, stream_playback_url: null, stream_status: null, stream_download_url: null, duration_seconds: null, created_at: iso(-1), updated_at: iso(-1) },
